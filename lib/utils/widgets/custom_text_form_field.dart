...
class CustomTextFormField extends StatefulWidget {
  ...
  CustomTextFormField(
      ...
      this.onTap,
      this.icon,
      this.type = CustomTextFormFieldType.rounded,
      this.validator,
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        disabledBorder: widget.type == CustomTextFormFieldType.rounded
            ? null
            : InputBorder.none,
        errorBorder: widget.type == CustomTextFormFieldType.rounded
            ? null
            : InputBorder.none,
        suffixIcon: widget.showClearIcon && widget.controller!.text != ''
            ? IconButton(
...
enum CustomTextFormFieldType { standard, rounded }
